...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Temukan <span>Mobil Terbaik Untuk Anda</span></h2>
      <p>Seluruh mobil yang tersedia merupakan mobil siap pakai dengan kelengkapan surat dan service. 
        Berkendara dengan mobil impianmu tidak pernah semudah ini sebelumnya. Mulailah berkendara dengan mobil impianmu sekarang.</p>
    </div>
    <div class="row"> 
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Testimonial <span>Pelanggan</span></h2>
    </div>
    <div class="row">
