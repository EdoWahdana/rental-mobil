...
<title>Car Rental Port | Detail Mobil</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post" autocomplete="off">
            <input type="hidden" name="price" id="price" value="<?= isset($promo) ? $promo : $result->PricePerDay ?>">
            <div class="form-group">
              <input class="form-control" name="fromdate" id="fromdate" placeholder="Tanggal Sewa" required>
            </div>
            <div class="form-group">
