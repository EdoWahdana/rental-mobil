...
<head>
	...
	<title>Car Rental Portal | Admin Manage Mobil</title>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Anda yakin ingin menghapus?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
