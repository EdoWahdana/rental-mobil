...
$msg="Pesanan Telah Berhasil Dikonfirmasi";
}
...
<head>
	...
	<title>Rental Dedi Jaya | Admin Manage Pesanan</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Pesanan</h2>
...
<td><?php echo htmlentities(number_format($result->TotalPay, 0, ',', '.'));?></td>
<?php if($result->Payment != NULL) { ?>
	<td><a href="../bukti_pembayaran/<?= $result->Payment ?>" target="blank"><span class="badge badge-info">Lihat Gambar</span></a></td>
<?php } else { ?>
	<td><p class="text-warning">Belum Upload Bukti</p></td>
<?php } ?>
<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->bid);?>" onclick="return confirm('Anda yakin akan menerima Pesanan ini?')"> Confirm</a> /
<a href="manage-bookings.php?eid=<?php echo htmlentities($result->bid);?>" onclick="return confirm('Anda yakin akan membatalkan Pesanan ini?')"> Cancel</a>
</td>
